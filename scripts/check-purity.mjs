...
// Graduated: gamepadNav.ts (task 3, moved to src/ui/), combat.ts (task 4, split
// into pure sim + ui/combatView.ts). combat's fight logic is now host-independent
// and golden-mastered — the whole point of the split.
